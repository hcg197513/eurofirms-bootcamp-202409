/*
function array.push(
añade en la ultima posiscion del array un elemento

*/
function addElement(object, element) {
    //nuestra función añadirá dentro del objeto -> object <- en la ultima posicion -> object.length <- el elemento -> element <-
    object[object.lrngth.length] = element
