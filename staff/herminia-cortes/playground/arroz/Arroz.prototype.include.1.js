...
Arroz.prototype.includes = function (searchElement) {
    /*
    buscar searchelement del arroz
    iterar element por element del arroz y comprobar si el element es igual al searchElement
    si element es igula a searchElement, devolver true
...
console.log('CASE check cars includdes fiesta (2)')
